...
function App() {
  ...
  // Utrošena energija i višak za sledeći obračun se predlažu netiranjem, ali
  // ostaju izmenjivi ako se račun razlikuje od izračunatog.
  useEffect(() => {
    const uneto = [
      utrosakPreuzetoVT,
      utrosakPreuzetoNT,
    ...
    setUtrosakUtrosenoVT(netirano.utrosenoVT);
    setUtrosakUtrosenoNT(netirano.utrosenoNT);
    setUtrosakVisakSledeciVT(netirano.visakSledeciVT);
    setUtrosakVisakSledeciNT(netirano.visakSledeciNT);
  }, [
    utrosakPreuzetoVT,
    utrosakPreuzetoNT,
    utrosakIsporucenoVT,
    ...
    <div className="row gy-5" style={{marginBottom: 20, fontSize: 14}}>
            ...
            <p style={{textAlign: 'left', flexGrow: 1}}>
              ...
              <HtmlTooltip2
                ...
                title={<React.Fragment>
                  ...
                  automatski predlažu netiranjem, odvojeno po tarifi (VT i NT), ali ih možete i ručno izmeniti.
      ...
      <div className="col-md-4">
        <div className="red-box" style={{display: 'flex', flexDirection: 'column', textAlign: 'left'}}>
          ...
          <div className="flex" style={{alignItems: 'center', justifyContent: 'space-between'}}>
          <span>
            Popust za plaćanje prethodnog računa u roku dospeća
            <HtmlTooltip
              enterTouchDelay={0}
              title={<React.Fragment>
    ...
    <If condition={calculated}>
      ...
      <div className="frame email">
        <table>
          ...
          <tr style={tdStyle}>
            <td>5.</td>
            <td colSpan={2} align="left">Popust za plaćanje prethodnog računa u roku dospeća</td>
            <td></td>
            <td></td>
            <td align="right">
              <If condition={popustPlacanje}>
